...
################################################################################
## Form generated from reading UI file 'designerxCWucH.ui'
##
...
"border-radius: 8")
        ...
        renderer = QSvgRenderer(Functions.set_svg_image("table-football.svg"))
        self.label_2.resize(renderer.defaultSize())
        painter = QPainter(self.label_2)
        painter.restore()
